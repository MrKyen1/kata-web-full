...
@Entity('hint_rewrite_questions')
@Unique(['questionId'])
export class HintRewriteQuestion extends BaseEntity {
  @Uuidv7PrimaryColumn()
  id!: string;
  ...
  @OneToOne(() => Question, (question) => question.hintRewriteDetail, {
    onDelete: 'CASCADE',
  })
  ...
  @Column({ name: 'must_use_hint', default: true })
  mustUseHint!: boolean;
